...
public class MapleReactorFactory {
	...
	private static final MapleDataProvider data = MapleDataProviderFactory
			.getDataProvider(new File(System.getProperty("wzpath") + "/Reactor.wz"));
	...
	public static MapleReactorStats getReactor(int rid) {
		...
		if (stats == null) {
			...
			if (stats == null) {
				...
				/*
				 * int i = 0; switch(rid) { case 2002011: case 2002012: case 2002013: case
				 * 2618003: case 2618004: case 2618005: case 2618006: case 2618007: case
				 * 2002018: case 9101000: case 2512001: case 6109016: case 6109017: case
				 * 6109018: case 6109019: case 6109020: i = 1; break; case 2006000: i = 20;
				 * break; } for (int x = 0; x < i; x++) { stats.addState((byte) x, 0, null,
				 * (byte) (x+1), 0); //test }
				 */
				...
				for (byte i = 0; true; i++) {
					...
					// 增加对更多触发物品的读取
					int startid = 0;
					while (reactorInfoData_ != null && reactorInfoData_.getChildByPath("" + startid) != null) {
						MapleData reactorInfoData = reactorInfoData_.getChildByPath("" + startid);
						Pair<Integer, Integer> reactItem = null;
						int type = MapleDataTool.getIntConvert("type", reactorInfoData);
						if (type == 100) { // reactor waits for item
							reactItem = new Pair<>(MapleDataTool.getIntConvert("0", reactorInfoData),
						...
						stats.addState(i, type, reactItem, (byte) MapleDataTool.getIntConvert("state", reactorInfoData),
								...
								(byte) (canTouch ? 2
										: (MapleDataTool.getIntConvert("2", reactorInfoData, 0) > 0
